...
class Tutor extends Component {
  ...
  handleClickOnTag(key) {
    ...
    if (this.state.chosenTags.includes(key))
      newTags = this.state.chosenTags.filter(element => element !== key);
    ...
    return (
      <div className="bg bg-gray pb-4">
        ...
        <div className="row mt-4 mb-4">
          <SearchBar
            className="shadow rounded col-5 bg-white mx-auto"
            style={{ height: 50 }}
          />
        </div>
          ...
          <div className="col-10 offset-1">
            ...
            <div className="row justify-content-around mt-5">
              ...
              <TutorCard
                ...
                rate={3}
                price="53"
                img="/vendors/img/user-avatar.jpg"
                description="fficia velit fugiat in Lorem ad do aute nisi do. Et cillum anim
